...
export const getOwnerLogsWithoutPagination = async (filterValues) => {
  try {
    const params = {
    }
    ...
    const res = await axios.get(
      `${import.meta.env.VITE_API_URL}AdminLog/getAllWithoutPagination`,{params,withCredentials: true},
    );
    return res.data;
  }
 catch (error) {
