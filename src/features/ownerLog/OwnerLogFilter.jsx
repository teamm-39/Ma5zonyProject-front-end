...
function OwnerLogsFilter({ onFilter }) {
        ...
        <AppAccordion>
          <div className="row">
            ...
            <div className="form-group col-12 col-md-4 mt-4">
              <label htmlFor="oldName">اسم المالك القديم</label>
              <input
                type="text"
                id="oldName"
            ...
            <div className="form-group col-12 col-md-4 mt-4">
              <label htmlFor="newName">اسم المالك الجديد</label>
              <input
                type="text"
                id="newName"
            ...
            <div className="form-group col-12 col-md-4 mt-4">
              <label htmlFor="oldAge">عمر المالك القديم</label>
              <InputText
                id="oldAge"
                min={1}
            ...
            <div className="form-group col-12 col-md-4 mt-4">
              <label htmlFor="newAge">عمر المالك الجديد</label>
              <InputText
                id="newAge"
                min={1}
...
OwnerLogsFilter.propTypes = {
  onFilter: PropTypes.func.isRequired,
};

export default OwnerLogsFilter;
