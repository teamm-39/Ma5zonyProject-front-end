export const employeeLogTableToPdf = (data, filters) => {
  ...
  <div class="text-center mt-3">
    <div class="mb-2 d-flex justify-content-around">
      <div>
        <span class="fw-bold">نوع التقرير: تقارير الموظفين</span>
      </div>
      <div>
    ...
    <div class="row justify-content-center mt-2 ">
      ...
      <div class="col-3">
        اسم الموظف القديم: ${filters?.oldName || "-"}
      </div>
      <div class="col-3">
        اسم الموظف الجديد: ${filters?.newName || "-"}
      </div>
      <div class="col-3">
        اسم المستخدم القديم للموظف: ${filters?.oldUserName || "-"}
      </div>
      <div class="col-3">
        اسم المستخدم الجديد للموظف: ${filters?.newUserName || "-"}
      </div>
    ...
    <table class="table table-bordered mt-3">
      <thead class="table-light">
        <tr>
          ...
          <th class="p-1 border text-center align-content-center" style="font-size:10px;">اسم الموظف</th>
          <th class="p-1 border text-center align-content-center" style="font-size:10px;">اسم المستخدم للموظف</th>
          <th class="p-1 border text-cente align-content-centerr" style="font-size:10px;">عمر الموظف</th>
