...
export const getEmployeeLogsWithoutPagination = async (filterValues) => {
  try {
    const params = {
    }
    ...
    const res = await axios.get(
      `${import.meta.env.VITE_API_URL}UserLog/getAllWithoutPagination`,{params,withCredentials: true},
    );
    return res.data;
  }
 catch (error) {
