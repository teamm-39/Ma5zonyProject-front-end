export const customerLogTableToPdf = (data, filters) => {
  ...
  <div class="text-center mt-3">
    <div class="mb-2 d-flex justify-content-around">
      <div>
        <span class="fw-bold">نوع التقرير: تقارير العملاء</span>
      </div>
      <div>
    ...
    <div class="row justify-content-center mt-2">
      ...
      <div class="col-3">
        اسم العميل القديم: ${filters?.oldName || "-"}
      </div>
      <div class="col-3">
        اسم العميل الجديد: ${filters?.newName || "-"}
      </div>
            <div class="col-3">
    ...
    <table class="table table-bordered mt-3">
      <thead class="table-light">
        <tr>
          ...
          <th class="p-1 border text-center" style="font-size:10px;">اسم العميل</th>
          <th class="p-1 border text-center" style="font-size:10px;">عمر العميل</th>
          <th class="p-1 border text-center" style="font-size:10px;">البريد الالكترونى</th>
          <th class="p-1 border text-center" style="font-size:10px;">مكان العميل</th>
